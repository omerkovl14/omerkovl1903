...
CREATE TABLE `personeller` (
  ...
  `kadroGorev` varchar(45) NOT NULL,
  `sifre` varchar(45) CHARACTER SET armscii8 COLLATE armscii8_general_ci NOT NULL,
  `statu` varchar(45) NOT NULL,
  `IZINGUNU` varchar(45) NOT NULL,
  `CalismaSaati` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `personeller` VALUES (10,'admin','admin','1234','admin','admin@gmail.com','admin.adres','sicil','güvenlik','1234','Yonetici','Sali','-');
